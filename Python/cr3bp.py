...
class PeriodicOrbit(Cr3bp):
    ...
    def runFullSimulationUntilTermination( self, initialState, initialTime, terminationFunction, max_step=1, maxTime=5000.0 ):      
        ...
        stateTransitionSolution = odeintw(stateTransFun, np.eye(6), integrator.t)
                
        return integrator, stateTransitionSolution
...
#     #                     dL=0.001, dLsave=0.005, dLmin=1E-4, totalDeltaL=[0.3,0.3], fileName=fileName)
