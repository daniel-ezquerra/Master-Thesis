...
public:
    ...
    double timeNormalizedToDimensional(const double normalizedTime){
        return normalizedTime / sqrt((gravParamPrimary + gravParamSecondary) / pow(distanceBodies, 3));
    }
